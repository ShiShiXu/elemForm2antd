...
// export const GET_MOCK_CONF = () => get(BASE_URL + 'mockConfDetail.json')
export const GET_MOCK_CONF = () => get(BASE_URL + 'mockConfSlim.json')
// export const GET_MOCK_CONF = () => get(BASE_URL + 'mockConfSlim-right.json')
